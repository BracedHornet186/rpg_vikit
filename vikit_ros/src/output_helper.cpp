                   ...
                   rclcpp::Duration lifetime)
{
  ...
  msg.header.frame_id = "world"; // Removed leading slash for ROS 2 convention, though /world still works
  ...
  // Initialize orientation to identity to avoid warnings
                    ...
                    const Vector3d& color)
{
  ...
  marker.pose.orientation.x = 0.08198092; // Note: original code reused values, might be typo in original but preserved here
  marker.pose.orientation.y = 0.34727674;
  marker.pose.orientation.z = -0.21462883;
  marker.pose.orientation.w = 0.9091823;
  marker.id--;
                        ...
                        rclcpp::Duration lifetime)
{
  ...
  marker.points.push_back(point);
  marker.scale.x = 0.1 * marker_scale; // Shaft diameter
  marker.scale.y = 0.2 * marker_scale; // Head diameter
  marker.scale.z = 0.0;
  marker.color.a = 1.0;
  marker.color.r = 1.0;
  marker.color.g = 0.0;
